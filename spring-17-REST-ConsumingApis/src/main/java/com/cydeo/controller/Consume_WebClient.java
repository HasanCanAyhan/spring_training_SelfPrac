...
public class Consume_WebClient {
    ...
    private WebClient webClient = WebClient.builder().baseUrl("http://localhost:8080").build(); // we are consuming our own api just example
    ...
    // those things are how to create and how to use.
...
//    ---------------------------WEBCLIENT---------------------------
    ...
    // this part is how to consume, if the endpoint-api is reactive?
    @GetMapping("/flux")
    public Flux<MovieCinemaDTO> readWithWebClient(){

        return webClient
                .get()
                .uri("/flux-movie-cinemas") // additional to base url
