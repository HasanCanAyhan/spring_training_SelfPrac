...
public class StudentControllerTest {
    ...
    //Controller class itself  has a dependency StudentService , i need to mock this bean

    @MockBean // @Mock for mochito works with object, but @MockBean works with Bean
    ...
    void getStudent_Test() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/student")
                ...
                .andExpect(content().json("{\"firstName\": \"Mike\", \"lastName\":  \"Smith\", \"age\": 20}")) // hard coded way
                .andDo(print()) // to show information on console
                .andReturn();
    }
    ...
    void jsonAssert_Test() throws Exception {
        ...
        //String expected = "{\"firstName\": \"Mike\", \"lastName\":  \"Smith\"}"; // for false statement
    ...
    void getStudents_Test() throws Exception {
        ...
        when(studentService.getStudents()).thenReturn(Arrays.asList( // i mocked for studentService
                //returns List StudentDto
                new StudentDTO("John","Doe",20),
                new StudentDTO("Tom","Hanks",50)
        ));// creating my stub (behavior for my moc object/StudentService obj)
